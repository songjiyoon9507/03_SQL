...
SELECT NAME, PHONE, BUS_DEPARTURES, BUS_ARRIVALS, BUS_DEPARTURE_TIME, BUS_NO, SEAT_NO
FROM RESERVE_PERSON
WHERE NAME = '홍길동'
AND PHONE = 01011111111;
...
SELECT BUS_NO, BUS_DEPARTURES, BUS_ARRIVALS,
BUS_DEPARTURE_TIME, BUS_ARRIVAL_TIME, COUNT(SEAT_RESERVATION)
FROM BUS
JOIN BUS_SEAT USING(BUS_NO)
WHERE SEAT_RESERVATION = 'N'
GROUP BY BUS_NO, BUS_DEPARTURES, BUS_ARRIVALS,
