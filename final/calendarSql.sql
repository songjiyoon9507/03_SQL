...
ALTER TABLE MEETING_ROOM ADD MEETING_ROOM_DEL_FL VARCHAR2(1) NULL;
...
UPDATE MEETING_ROOM SET MEETING_ROOM_DEL_FL = 'N';

UPDATE MEETING_ROOM SET MEETING_ROOM_NM = '삭제된 회의실입니다.' WHERE MEETING_ROOM_NO = 14;
